...
<div class="question">
	...
	<p on:keypress={() => {}} on:click={() => handleGiveAnswer(question.id, 0)}>
		{question.answers[0].answer}
	</p>
	<p on:keypress={() => {}} on:click={() => handleGiveAnswer(question.id, 1)}>
		{question.answers[1].answer}
	</p>
	<p on:keypress={() => {}} on:click={() => handleGiveAnswer(question.id, 2)}>
